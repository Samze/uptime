...
<<<<<<< HEAD
      console.log("-error needingPoll -" + res.statusCode);
=======
>>>>>>> e01c33099aab60b92627bd225d8520d477d0a828
...
Monitor.prototype.declarePoll = function(check, callback) {
  ...
  var req = http.request(options, function(res) {
    if (res.statusCode != 200 && res.statusCode != 401) {
<<<<<<< HEAD
      console.log("-error poll -" + res.statusCode);
=======
>>>>>>> e01c33099aab60b92627bd225d8520d477d0a828
...
Monitor.prototype.createPing = function(error, check, timestamp, time, details, callback) {
  ...
  var req = http.request(options, function(res) {
    if (res.statusCode != 200 && res.statusCode != 401) {
<<<<<<< HEAD
      console.log("-error Ping -" + res.statusCode);
=======
>>>>>>> e01c33099aab60b92627bd225d8520d477d0a828
